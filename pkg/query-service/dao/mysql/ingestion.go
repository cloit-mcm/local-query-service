...
func (mds *ModelDaoMysql) GetIngestionKeys(ctx context.Context) ([]model.IngestionKey, *model.ApiError) {
...
func (mds *ModelDaoMysql) InsertIngestionKey(ctx context.Context, ingestion_key *model.IngestionKey) *model.ApiError {
